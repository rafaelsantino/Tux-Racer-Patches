...
#
#	$Id: DirTree.tcl,v 1.5 2009/03/27 23:09:21 hobbs Exp $
#
# DirTree.tcl --
#
...
proc tixDirTree:AddToList {w fsdir image} {
	...
	if {[string compare $dir $sib] < 0} {
	    $data(w:hlist) add $dir -itemtype imagetext \
		-before $sib -text $text -image $image
	    set added 1
	    break
	}
    }
    if {!$added} {
	$data(w:hlist) add $dir -itemtype imagetext -text $text -image $image
    }
